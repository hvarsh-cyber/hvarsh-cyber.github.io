    ...
    <footer className="footer">
      <div className="container footer-inner">
        <div className="footer-left">
          ...
          <p className="footer-tagline">Security Automation Engineer · Monash University</p>
        </div>
        <div className="footer-right">
          <div className="footer-connect-links">
            <a
              href="https://github.com/hvarsh-cyber"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/himavarsh-s-0a215b213"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-connect-btn footer-connect-linkedin"
              aria-label="LinkedIn"
            >
              <LinkedinIcon />
              <span>LinkedIn</span>
            ...
            <a
              href="mailto:himavarshs329@gmail.com"
              className="footer-connect-btn footer-connect-email"
              aria-label="Email"
            >
              <Mail size={28} />
              <span>Email</span>
